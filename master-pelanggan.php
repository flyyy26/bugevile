        ...
        <div class="bg-white p-6 rounded-2xl">
            <div class="flex justify-between items-end mb-4 w-full">
                ...
                <form class="m-max">   
                    ...
                    <div class="relative">
                        ...
                        <input type="search" id="default-search" class="block w-full p-4 py-2.5 ps-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-slate-600 focus:ring-blue-500 focus:border-blue-500 " placeholder="Cari Pelanggan" required />
            ...
            <table class="border-collapse border border-slate-500 w-full">
                ...
                <tr>
                    ...
                    <td class="border border-slate-600 font-normal py-3 px-2 text-center">
                    ...
                    <td class="border border-slate-600 font-normal py-3 px-1 text-center">Cibeureum</td>
                ...
                <tr>
                    ...
                    <td class="border border-slate-600 font-normal py-3 px-2 text-center">Muhamad Rafli</td>
                    <td class="border border-slate-600 font-normal py-3 px-2 text-center">
                        <div class="relative flex justify-center items-center gap-2">
                            (+62) 895610411991
                            <button type="button" class="rounded-md bg-green-500 px-1 py-0.5 text-xs font-normal text-white shadow-sm hover:bg-green-700"><i class="ri-phone-fill"></i></button>
                    ...
                    <td class="border border-slate-600 font-normal py-3 px-2 text-center">Kp. Bojongnangka 02/03 Sukamenak Purbaratu</td>
                    <td class="border border-slate-600 font-normal py-3 px-1 text-center ">
                        <div class="flex gap-2 justify-center">
                            <button type="button" class="rounded-md bg-blue-500 px-2 py-1 text-base font-normal text-white shadow-sm hover:bg-blue-700 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"><i class="ri-edit-2-line"></i></button>
                            <button type="button" class="rounded-md bg-red-500 px-2 py-1 text-base font-normal text-white shadow-sm hover:bg-red-700 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"><i class="ri-delete-bin-line"></i></button>
                ...
                <tr>
                    ...
                    <td class="border border-slate-600 font-normal py-3 px-1 text-center">Abdul Yakub Hasbullah</td>
                    <td class="border border-slate-600 font-normal py-3 px-2 text-center">
                        <div class="relative flex justify-center items-center gap-2">
                            (+62) 878561357189
                            <button type="button" class="rounded-md bg-green-500 px-1 py-0.5 text-xs font-normal text-white shadow-sm hover:bg-green-700"><i class="ri-phone-fill"></i></button>
                    ...
                    <td class="border border-slate-600 font-normal py-3 px-1 text-center">Singaparna</td>
                    <td class="border border-slate-600 font-normal py-3 px-1 text-center">
                        <div class="flex gap-2 justify-center">
                            <button type="button" class="rounded-md bg-blue-500 px-2 py-1 text-base font-normal text-white shadow-sm hover:bg-blue-700 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"><i class="ri-edit-2-line"></i></button>
                            <button type="button" class="rounded-md bg-red-500 px-2 py-1 text-base font-normal text-white shadow-sm hover:bg-red-700 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"><i class="ri-delete-bin-line"></i></button>
                ...
                <tr>
                    ...
                    <td class="border border-slate-600 font-normal py-3 px-1 text-center">Komplek Eks Kewedanaan Singaparna SINGASARI KEC. SINGAPARNA KAB. TASIKMALAYA</td>
                    <td class="border border-slate-600 font-normal py-3 px-1 text-center">
                        <div class="flex gap-2 justify-center">
                            <button type="button" class="rounded-md bg-blue-500 px-2 py-1 text-base font-normal text-white shadow-sm hover:bg-blue-700 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"><i class="ri-edit-2-line"></i></button>
                            <button type="button" class="rounded-md bg-red-500 px-2 py-1 text-base font-normal text-white shadow-sm hover:bg-red-700 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"><i class="ri-delete-bin-line"></i></button>
                ...
                <tr>
                    <td class="border border-slate-600 font-normal py-3 px-1 text-center">3</td>
                    <td class="border border-slate-600 font-normal py-3 px-1 text-center">Diky Rayi Pamungkas</td>
                    <td class="border border-slate-600 font-normal py-3 px-2 text-center">
                        <div class="relative flex justify-center items-center gap-2">
                            (+62) 86235624742
                            <button type="button" class="rounded-md bg-green-500 px-1 py-0.5 text-xs font-normal text-white shadow-sm hover:bg-green-700"><i class="ri-phone-fill"></i></button>
                    ...
                    <td class="border border-slate-600 font-normal py-3 px-1 text-center">Jl. Pataruman Tasikmalaya</td>
                    <td class="border border-slate-600 font-normal py-3 px-1 text-center">
                        <div class="flex gap-2 justify-center">
                            <button type="button" class="rounded-md bg-blue-500 px-2 py-1 text-base font-normal text-white shadow-sm hover:bg-blue-700 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"><i class="ri-edit-2-line"></i></button>
                            <button type="button" class="rounded-md bg-red-500 px-2 py-1 text-base font-normal text-white shadow-sm hover:bg-red-700 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"><i class="ri-delete-bin-line"></i></button>
