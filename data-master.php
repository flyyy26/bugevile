    ...
    <div class="bg-white p-6 rounded-2xl">
        <div class="flex justify-between items-end mb-4 w-full">
            <form class="w-max flex justify-center items-center gap-3">
                <select id="countries" class="bg-slate-600 text-white border border-slate-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block p-2.5 py-2.5">
        ...
        <table class="border-collapse border border-slate-500 w-full">
            ...
            <tr>
                ...
                <td class="border border-slate-600 font-normal py-3 px-1 text-center">JRB01PDK</td>
                <td class="border border-slate-600 font-normal py-3 px-1 text-center">Jersey Roadbike Pendek</td>
                <td class="border border-slate-600 font-normal py-3 px-1 text-center">Classic</td>
                <td class="border border-slate-600 font-normal py-3 px-1 text-center">Single Print</td>
                <td class="border border-slate-600 font-normal py-3 px-1 text-center">Rp. 80.000</td>
                <td class="border border-slate-600 font-normal py-3 px-1 text-center">Rp. 100.000</td>
                <td class="border border-slate-600 font-normal py-3 px-1 text-center">Rp. 180.000</td>
                <td class="border border-slate-600 font-normal py-3 px-1 text-center">
            ...
            <tr>
                <td class="border border-slate-600 font-normal py-3 px-1 text-center">2</td>
                <td class="border border-slate-600 font-normal py-3 px-1 text-center">JRB02PDK</td>
                <td class="border border-slate-600 font-normal py-3 px-1 text-center">Jersey Roadbike Pendek</td>
                <td class="border border-slate-600 font-normal py-3 px-1 text-center">Classic</td>
                <td class="border border-slate-600 font-normal py-3 px-1 text-center">Full Print</td>
                <td class="border border-slate-600 font-normal py-3 px-1 text-center">Rp. 80.000</td>
                <td class="border border-slate-600 font-normal py-3 px-1 text-center">Rp. 100.000</td>
                <td class="border border-slate-600 font-normal py-3 px-1 text-center">Rp. 180.000</td>
                <td class="border border-slate-600 font-normal py-3 px-1 text-center">
            ...
            <tr>
                <td class="border border-slate-600 font-normal py-3 px-1 text-center">3</td>
                <td class="border border-slate-600 font-normal py-3 px-1 text-center">JRB03PDK</td>
                <td class="border border-slate-600 font-normal py-3 px-1 text-center">Jersey Roadbike Pendek</td>
                <td class="border border-slate-600 font-normal py-3 px-1 text-center">Reglan</td>
                <td class="border border-slate-600 font-normal py-3 px-1 text-center">Single Print</td>
                <td class="border border-slate-600 font-normal py-3 px-1 text-center">Rp. 80.000</td>
                <td class="border border-slate-600 font-normal py-3 px-1 text-center">Rp. 100.000</td>
                <td class="border border-slate-600 font-normal py-3 px-1 text-center">Rp. 180.000</td>
            ...
            <tr>
                <td class="border border-slate-600 font-normal py-3 px-1 text-center">4</td>
                <td class="border border-slate-600 font-normal py-3 px-1 text-center">JRB04PDK</td>
                <td class="border border-slate-600 font-normal py-3 px-1 text-center">Jersey Roadbike Pendek</td>
                <td class="border border-slate-600 font-normal py-3 px-1 text-center">Reglan</td>
                <td class="border border-slate-600 font-normal py-3 px-1 text-center">Full Print</td>
                <td class="border border-slate-600 font-normal py-3 px-1 text-center">Rp. 80.000</td>
            ...
            <tr>
                <td class="border border-slate-600 font-normal py-3 px-1 text-center">5</td>
                <td class="border border-slate-600 font-normal py-3 px-1 text-center">JRB01PJG</td>
                <td class="border border-slate-600 font-normal py-3 px-1 text-center">Jersey Roadbike Panjang</td>
                <td class="border border-slate-600 font-normal py-3 px-1 text-center">Classic</td>
                <td class="border border-slate-600 font-normal py-3 px-1 text-center">Single Print</td>
                <td class="border border-slate-600 font-normal py-3 px-1 text-center">Rp. 80.000</td>
                <td class="border border-slate-600 font-normal py-3 px-1 text-center">Rp. 100.000</td>
            ...
            <tr>
                <td class="border border-slate-600 font-normal py-3 px-1 text-center">6</td>
                <td class="border border-slate-600 font-normal py-3 px-1 text-center">JRB02PJG</td>
                <td class="border border-slate-600 font-normal py-3 px-1 text-center">Jersey Roadbike Panjang</td>
                <td class="border border-slate-600 font-normal py-3 px-1 text-center">Classic</td>
                <td class="border border-slate-600 font-normal py-3 px-1 text-center">Full Print</td>
                <td class="border border-slate-600 font-normal py-3 px-1 text-center">Rp. 80.000</td>
            ...
            <tr>
                <td class="border border-slate-600 font-normal py-3 px-1 text-center">7</td>
                <td class="border border-slate-600 font-normal py-3 px-1 text-center">JRB03PJG</td>
                <td class="border border-slate-600 font-normal py-3 px-1 text-center">Jersey Roadbike Panjang</td>
                <td class="border border-slate-600 font-normal py-3 px-1 text-center">Reglan</td>
                <td class="border border-slate-600 font-normal py-3 px-1 text-center">Single Print</td>
                <td class="border border-slate-600 font-normal py-3 px-1 text-center">Rp. 80.000</td>
            ...
            <tr>
                <td class="border border-slate-600 font-normal py-3 px-1 text-center">8</td>
                <td class="border border-slate-600 font-normal py-3 px-1 text-center">JRB04PJG</td>
                <td class="border border-slate-600 font-normal py-3 px-1 text-center">Jersey Roadbike Panjang</td>
                <td class="border border-slate-600 font-normal py-3 px-1 text-center">Reglan</td>
                <td class="border border-slate-600 font-normal py-3 px-1 text-center">Full Print</td>
                <td class="border border-slate-600 font-normal py-3 px-1 text-center">Rp. 80.000</td>
