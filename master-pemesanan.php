...
<div class="p-10 max-h-max">
    ...
    <div class="bg-white p-8 rounded-2xl">
        <form>
            ...
            <div class="mt-9 mx-auto flex items-center justify-center gap-x-6">
        ...
        <div class="bg-white p-6 rounded-2xl">
            ...
            <table class="border-collapse border border-slate-500 w-full">
                ...
                <tr>
                    ...
                    <td class="border border-slate-600 font-normal py-3 px-1 text-center">PO20242510034259</td>
                    <td class="border border-slate-600 font-normal py-3 px-1 text-center">26/08/2024</td>
                    <td class="border border-slate-600 font-normal py-3 px-1 text-center">Jersey Roadbike Pendek</td>
                    <td class="border border-slate-600 font-normal py-3 px-1 text-center">Pak Oceng</td>
                    <td class="border border-slate-600 font-normal py-3 px-1 text-center">Desain</td>
                ...
                <tr>
                    ...
                    <td class="border border-slate-600 font-normal py-3 px-1 text-center">PO20242510034259</td>
                    <td class="border border-slate-600 font-normal py-3 px-1 text-center">12/10/2024</td>
                    <td class="border border-slate-600 font-normal py-3 px-1 text-center">Jersey Roadbike Panjang</td>
                    <td class="border border-slate-600 font-normal py-3 px-1 text-center">Muhamad Rafli</td>
                    <td class="border border-slate-600 font-normal py-3 px-1 text-center">Pola</td>
                    <td class="border border-slate-600 font-normal py-3 px-1 text-center">
                        <div class="flex gap-2 justify-center">
                            <button type="button" class="rounded-md bg-blue-500 px-2 py-1 text-base font-normal text-white shadow-sm hover:bg-blue-700 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"><i class="ri-search-line"></i></button>
                            <button type="button" class="rounded-md bg-red-500 px-2 py-1 text-base font-normal text-white shadow-sm hover:bg-red-700 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"><i class="ri-delete-bin-line"></i></button>
                ...
                <tr>
                    ...
                    <td class="border border-slate-600 font-normal py-3 px-1 text-center">PO20242510034259</td>
                    <td class="border border-slate-600 font-normal py-3 px-1 text-center">16/11/2024</td>
                    <td class="border border-slate-600 font-normal py-3 px-1 text-center">Jersey Roadbike Panjang</td>
                    <td class="border border-slate-600 font-normal py-3 px-1 text-center">Muhamad Sihabuddin</td>
                    <td class="border border-slate-600 font-normal py-3 px-1 text-center">Layout Print</td>
                    <td class="border border-slate-600 font-normal py-3 px-1 text-center">
                        <div class="flex gap-2 justify-center">
                            <button type="button" class="rounded-md bg-blue-500 px-2 py-1 text-base font-normal text-white shadow-sm hover:bg-blue-700 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"><i class="ri-search-line"></i></button>
                            <button type="button" class="rounded-md bg-red-500 px-2 py-1 text-base font-normal text-white shadow-sm hover:bg-red-700 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"><i class="ri-delete-bin-line"></i></button>
                ...
                <tr>
                    ...
                    <td class="border border-slate-600 font-normal py-3 px-1 text-center">PO20242510034259</td>
                    <td class="border border-slate-600 font-normal py-3 px-1 text-center">05/11/2024</td>
                    <td class="border border-slate-600 font-normal py-3 px-1 text-center">Jersey Roadbike Pendek</td>
                    <td class="border border-slate-600 font-normal py-3 px-1 text-center">Abdul Yakup Hasbullah</td>
                    <td class="border border-slate-600 font-normal py-3 px-1 text-center">Press</td>
                    <td class="border border-slate-600 font-normal py-3 px-1 text-center">
                        <div class="flex gap-2 justify-center">
                            <button type="button" class="rounded-md bg-blue-500 px-2 py-1 text-base font-normal text-white shadow-sm hover:bg-blue-700 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"><i class="ri-search-line"></i></button>
                            <button type="button" class="rounded-md bg-red-500 px-2 py-1 text-base font-normal text-white shadow-sm hover:bg-red-700 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"><i class="ri-delete-bin-line"></i></button>
